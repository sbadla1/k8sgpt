...
require (
	...
	github.com/sbadla1/k8sgpt-schemas v0.0.0-20231121004314-e1adeac17e78
)

require (
	buf.build/gen/go/k8sgpt-ai/k8sgpt/protocolbuffers/go v1.31.0-20231002095256-194bc640518b.1 // indirect
